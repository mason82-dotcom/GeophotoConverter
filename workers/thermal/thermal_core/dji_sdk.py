...
class DjiThermalSdk:
    ...
    DJI Thermal SDK binaries are intentionally not distributed with GeoPhotoConverter.
    ...
    def __init__(self, sdk_dir: str | os.PathLike[str], *, sdk_label: str | None = None):
        if ctypes.sizeof(ctypes.c_void_p) != 8:
            raise RuntimeError("GeoPhotoConverter thermal worker currently requires a 64-bit Python runtime")
