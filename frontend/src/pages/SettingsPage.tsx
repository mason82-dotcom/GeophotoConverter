  ...
  if (loading) {
    return (
      <div className="panel loading-state" role="status">
        ...
        <span>Arbeitsstations-Einstellungen werden geladen …</span>
      </div>
    )
  }
    ...
    <div className="settings-layout">
      <section className="panel">
        <div className="section-heading">
          <div>
            ...
            <p>Schreibgeschützter Status aus der relativen GeoPhoto-API.</p>
          </div>
      ...
      <section className="panel">
        ...
        <div className="settings-form">
          <fieldset>
            <legend>Oberflächendichte</legend>
            <label className="radio-setting">
              ...
              />
              <span><strong>Komfortabel</strong><small>Standardabstände und normale Bedienziele.</small></span>
            </label>
            <label className="radio-setting">
              <input
                type="radio"
              ...
              />
              <span><strong>Kompakt</strong><small>Höhere Informationsdichte für Desktop-Arbeitsstationen.</small></span>
            </label>
          </fieldset>
          ...
          <label className="toggle-setting">
            <span>
              ...
              <small>Wird lokal für das Frontend-Polling gespeichert. Keine Backend-Einstellung wird geändert.</small>
            </span>
            <input
              type="checkbox"
              checked={autoRefresh}
