      ...
      <section className="panel">
        ...
        <div className="service-overview-card">
          ...
          <div>
            ...
            <strong>{statusText(dronedb?.status)}</strong>
          ...
          <span className={`status-chip ${dronedb ? 'status-chip--uploaded' : 'status-chip--error'}`}>
            ...
            {dronedb ? 'Konfiguriert' : 'Nicht gemeldet'}
          </span>
        </div>
      </section>
      ...
      <section className="panel publish-panel">
        ...
        <div className="publish-action">
          <div>
            ...
            <div>
              <strong>Veröffentlichung in V1.0 deaktiviert</strong>
              <span>Die optionale DroneDB-Veröffentlichung gehört nicht zum V1.0-Hauptworkflow.</span>
            </div>
          </div>
