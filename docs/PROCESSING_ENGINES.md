...
- SIFT-Feature-Extraktion und Matching verwenden `SiftExtraction.use_gpu=1` bzw. `SiftMatching.use_gpu=1`
- `GEOPHOTO_CUDA_DEVICE` wählt den GPU-Index; Standard ist `0`
