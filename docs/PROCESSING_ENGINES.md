...
- Der Worker staged ausschließlich vollständige Capture-Gruppen; unvollständige
  Gruppen werden im Input-Manifest als `incomplete_m3m_capture_group` ausgewiesen.
